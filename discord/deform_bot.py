...
def distort_image(fname, args):
    ...
    if anaglyph:
        ...
        stereocmd = f"magick composite " + os.path.join("results", f"{fname}") + " " + os.path.join("results", f"{fname}") + f" -stereo +{stereo_offset[0]}+{stereo_offset[1]} " + os.path.join("results", f"{fname}")
        os.system(stereocmd)
